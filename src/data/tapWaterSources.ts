...
export const TAP_WATER_ROUTES: TapWaterRoute[] = [
  ...
  // ── Nouvelle-Aquitaine (sud) ──
  {
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Gave de Pau', type: 'captage', lat: 43.2851, lng: -0.3708, description: "Prise d'eau dans le Gave de Pau" },
      { name: 'Usine de Bizanos', type: 'traitement', lat: 43.2920, lng: -0.3500, description: "Station de traitement d'eau potable" },
      { name: 'Réservoir du Hameau', type: 'reservoir', lat: 43.3020, lng: -0.3650, description: 'Réservoir de distribution' },
      { name: 'Pau', type: 'commune', lat: 43.2951, lng: -0.3708, description: 'Distribution aux 77 000 habitants' },
    ],
    communes: [
      { name: 'Billère', lat: 43.3050, lng: -0.3900, population: 13000 },
      { name: 'Lons', lat: 43.3170, lng: -0.4050, population: 12000 },
      { name: 'Jurançon', lat: 43.2850, lng: -0.3880, population: 7500 },
      { name: 'Lescar', lat: 43.3330, lng: -0.4280, population: 10500 },
      { name: 'Bizanos', lat: 43.2900, lng: -0.3450, population: 5000 },
    ],
  },
  {
    id: 'bayonne',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Nive / Adour', type: 'captage', lat: 43.4833, lng: -1.4833, description: "Prise d'eau dans la Nive" },
      { name: 'Usine de Polo-Beyris', type: 'traitement', lat: 43.4750, lng: -1.4700, description: 'Station de traitement' },
      { name: 'Réservoir de Marracq', type: 'reservoir', lat: 43.4800, lng: -1.4600, description: 'Réservoir principal' },
      { name: 'Bayonne', type: 'commune', lat: 43.4929, lng: -1.4748, description: 'Distribution aux 52 000 habitants' },
    ],
    communes: [
      { name: 'Anglet', lat: 43.4833, lng: -1.5167, population: 40000 },
      { name: 'Biarritz', lat: 43.4832, lng: -1.5586, population: 25000 },
      { name: 'Boucau', lat: 43.5230, lng: -1.4870, population: 8500 },
      { name: 'Saint-Pierre-d\'Irube', lat: 43.4650, lng: -1.4500, population: 5000 },
    ],
  },
  {
    id: 'la-rochelle',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Nappe du Cénomanien', type: 'captage', lat: 46.1400, lng: -1.1200, description: 'Captage nappe profonde du Cénomanien' },
      { name: 'Usine de Coulonge', type: 'traitement', lat: 46.1500, lng: -1.1300, description: 'Station de traitement' },
      { name: 'Réservoir de Lagord', type: 'reservoir', lat: 46.1850, lng: -1.1400, description: 'Réservoir de distribution' },
      { name: 'La Rochelle', type: 'commune', lat: 46.1603, lng: -1.1511, description: 'Distribution aux 79 000 habitants' },
    ],
    communes: [
      { name: 'Aytré', lat: 46.1340, lng: -1.1110, population: 10000 },
      { name: 'Lagord', lat: 46.1870, lng: -1.1540, population: 8000 },
      { name: 'Périgny', lat: 46.1480, lng: -1.1010, population: 9500 },
      { name: 'Puilboreau', lat: 46.1850, lng: -1.1240, population: 6000 },
      { name: 'Nieul-sur-Mer', lat: 46.2050, lng: -1.1670, population: 6000 },
    ],
  },
  {
    id: 'poitiers',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Nappe alluviale du Clain', type: 'captage', lat: 46.5600, lng: 0.3400, description: 'Captage dans la nappe du Clain' },
      { name: 'Usine de Buxerolles', type: 'traitement', lat: 46.6000, lng: 0.3600, description: "Usine de production d'eau potable" },
      { name: 'Réservoir de la Blaiserie', type: 'reservoir', lat: 46.5900, lng: 0.3300, description: 'Château d\'eau principal' },
      { name: 'Poitiers', type: 'commune', lat: 46.5802, lng: 0.3404, description: 'Distribution aux 89 000 habitants' },
    ],
    communes: [
      { name: 'Buxerolles', lat: 46.6000, lng: 0.3550, population: 10500 },
      { name: 'Saint-Benoît', lat: 46.5500, lng: 0.3500, population: 7500 },
      { name: 'Mignaloux-Beauvoir', lat: 46.5450, lng: 0.3800, population: 5500 },
      { name: 'Chasseneuil-du-Poitou', lat: 46.6400, lng: 0.3650, population: 5500 },
    ],
  },
  {
    id: 'nimes',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Source du Lez / BRL', type: 'captage', lat: 43.8500, lng: 4.3600, description: 'Captage via le réseau BRL' },
      { name: 'Usine de Sauve', type: 'traitement', lat: 43.8400, lng: 4.3200, description: 'Station de potabilisation' },
      { name: 'Réservoir de la Tour Magne', type: 'reservoir', lat: 43.8400, lng: 4.3550, description: 'Réservoir haut-service' },
      { name: 'Nîmes', type: 'commune', lat: 43.8367, lng: 4.3601, description: 'Distribution aux 151 000 habitants' },
    ],
    communes: [
      { name: 'Milhaud', lat: 43.7880, lng: 4.3100, population: 6000 },
      { name: 'Marguerittes', lat: 43.8570, lng: 4.4340, population: 9500 },
      { name: 'Caissargues', lat: 43.8050, lng: 4.3600, population: 4200 },
      { name: 'Bouillargues', lat: 43.8040, lng: 4.3820, population: 6500 },
      { name: 'Saint-Gilles', lat: 43.6780, lng: 4.4310, population: 14000 },
    ],
  },
  {
    id: 'avignon',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Durance', type: 'captage', lat: 43.7300, lng: 5.1700, description: "Prise d'eau sur la Durance" },
      { name: 'Usine de Réalpanier', type: 'traitement', lat: 43.9200, lng: 4.8200, description: 'Usine de potabilisation' },
      { name: 'Réservoir des Angles', type: 'reservoir', lat: 43.9600, lng: 4.7600, description: 'Réservoir principal' },
      { name: 'Avignon', type: 'commune', lat: 43.9493, lng: 4.8055, description: 'Distribution aux 92 000 habitants' },
    ],
    communes: [
      { name: 'Le Pontet', lat: 43.9630, lng: 4.8590, population: 18000 },
      { name: 'Villeneuve-lès-Avignon', lat: 43.9670, lng: 4.7950, population: 13000 },
      { name: 'Vedène', lat: 43.9750, lng: 4.9010, population: 11500 },
      { name: 'Morières-lès-Avignon', lat: 43.9400, lng: 4.9020, population: 8500 },
      { name: 'Sorgues', lat: 44.0120, lng: 4.8700, population: 19000 },
    ],
  },
  {
    id: 'valence',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Rhône (La Paillasse)', type: 'captage', lat: 44.9100, lng: 4.8700, description: "Prise d'eau dans le Rhône" },
      { name: 'Usine de Mauboule', type: 'traitement', lat: 44.9200, lng: 4.8900, description: 'Station de traitement' },
      { name: 'Réservoir de Fontlozier', type: 'reservoir', lat: 44.9350, lng: 4.9000, description: 'Réservoir haut-service' },
      { name: 'Valence', type: 'commune', lat: 44.9334, lng: 4.8924, description: 'Distribution aux 65 000 habitants' },
    ],
    communes: [
      { name: 'Bourg-lès-Valence', lat: 44.9500, lng: 4.8850, population: 20000 },
      { name: 'Guilherand-Granges', lat: 44.9340, lng: 4.8700, population: 12000 },
      { name: 'Portes-lès-Valence', lat: 44.8770, lng: 4.8840, population: 11000 },
      { name: 'Saint-Marcel-lès-Valence', lat: 44.9730, lng: 4.9350, population: 5500 },
    ],
  },
  {
    id: 'chambery',
    ...
    sourceType: 'lac',
    steps: [
      { name: 'Lac du Bourget (captage)', type: 'captage', lat: 45.7300, lng: 5.8600, description: 'Captage dans le lac du Bourget' },
      { name: 'Usine de la Leysse', type: 'traitement', lat: 45.5800, lng: 5.9100, description: 'Station de potabilisation' },
      { name: 'Réservoir de Bellevue', type: 'reservoir', lat: 45.5700, lng: 5.9200, description: 'Réservoir de distribution' },
      { name: 'Chambéry', type: 'commune', lat: 45.5646, lng: 5.9178, description: 'Distribution aux 60 000 habitants' },
    ],
    communes: [
      { name: 'La Motte-Servolex', lat: 45.5970, lng: 5.8790, population: 12500 },
      { name: 'Cognin', lat: 45.5540, lng: 5.8960, population: 6500 },
      { name: 'Jacob-Bellecombette', lat: 45.5530, lng: 5.9100, population: 4000 },
      { name: 'Bassens', lat: 45.5800, lng: 5.9500, population: 4700 },
      { name: 'La Ravoire', lat: 45.5480, lng: 5.9460, population: 9000 },
    ],
  },
  {
    id: 'dunkerque',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Nappe d\'Artois', type: 'captage', lat: 50.9000, lng: 2.3500, description: 'Captage nappe de la craie' },
      { name: 'Usine de Moulle', type: 'traitement', lat: 50.8600, lng: 2.2500, description: 'Usine de potabilisation' },
      { name: 'Réservoir de Coudekerque', type: 'reservoir', lat: 51.0000, lng: 2.3700, description: 'Château d\'eau principal' },
      { name: 'Dunkerque', type: 'commune', lat: 51.0343, lng: 2.3768, description: 'Distribution aux 87 000 habitants' },
    ],
    communes: [
      { name: 'Grande-Synthe', lat: 51.0150, lng: 2.3050, population: 23000 },
      { name: 'Coudekerque-Branche', lat: 51.0180, lng: 2.3950, population: 22000 },
      { name: 'Saint-Pol-sur-Mer', lat: 51.0300, lng: 2.3450, population: 22000 },
      { name: 'Leffrinckoucke', lat: 51.0430, lng: 2.4350, population: 5000 },
      { name: 'Gravelines', lat: 50.9870, lng: 2.1290, population: 11000 },
    ],
  },
  {
    id: 'calais',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Nappe de la Craie', type: 'captage', lat: 50.9200, lng: 1.8500, description: 'Captage nappe de la craie' },
      { name: 'Usine des Attaques', type: 'traitement', lat: 50.9100, lng: 1.9200, description: 'Station de traitement' },
      { name: 'Réservoir de Coquelles', type: 'reservoir', lat: 50.9300, lng: 1.8000, description: 'Château d\'eau de distribution' },
      { name: 'Calais', type: 'commune', lat: 50.9513, lng: 1.8587, description: 'Distribution aux 73 000 habitants' },
    ],
    communes: [
      { name: 'Coquelles', lat: 50.9310, lng: 1.7940, population: 2500 },
      { name: 'Sangatte', lat: 50.9450, lng: 1.7560, population: 5000 },
      { name: 'Coulogne', lat: 50.9220, lng: 1.8940, population: 6000 },
      { name: 'Marck', lat: 50.9520, lng: 1.9530, population: 10000 },
    ],
  },
  {
    id: 'troyes',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Seine amont', type: 'captage', lat: 48.2800, lng: 4.0500, description: "Prise d'eau en Seine amont" },
      { name: 'Usine de la Chapelle-Saint-Luc', type: 'traitement', lat: 48.3050, lng: 4.0400, description: 'Station de traitement' },
      { name: 'Réservoir des Noës', type: 'reservoir', lat: 48.3000, lng: 4.0700, description: 'Château d\'eau' },
      { name: 'Troyes', type: 'commune', lat: 48.2973, lng: 4.0744, description: 'Distribution aux 62 000 habitants' },
    ],
    communes: [
      { name: 'La Chapelle-Saint-Luc', lat: 48.3110, lng: 4.0460, population: 13000 },
      { name: 'Saint-André-les-Vergers', lat: 48.2800, lng: 4.0350, population: 13000 },
      { name: 'Sainte-Savine', lat: 48.2950, lng: 4.0350, population: 10500 },
      { name: 'Saint-Julien-les-Villas', lat: 48.2800, lng: 4.0900, population: 7500 },
    ],
  },
  {
    id: 'colmar',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Nappe phréatique du Rhin', type: 'captage', lat: 48.0600, lng: 7.3700, description: 'Captage nappe rhénane' },
      { name: 'Usine de Colmar', type: 'traitement', lat: 48.0800, lng: 7.3500, description: 'Station de traitement' },
      { name: 'Réservoir de Horbourg', type: 'reservoir', lat: 48.0850, lng: 7.3900, description: 'Réservoir de distribution' },
      { name: 'Colmar', type: 'commune', lat: 48.0794, lng: 7.3558, description: 'Distribution aux 70 000 habitants' },
    ],
    communes: [
      { name: 'Horbourg-Wihr', lat: 48.0840, lng: 7.3990, population: 6000 },
      { name: 'Wintzenheim', lat: 48.0730, lng: 7.2950, population: 8000 },
      { name: 'Ingersheim', lat: 48.0950, lng: 7.3070, population: 5000 },
      { name: 'Turckheim', lat: 48.0860, lng: 7.2780, population: 3800 },
    ],
  },
  {
    id: 'saint-nazaire',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Loire (Cordemais)', type: 'captage', lat: 47.2900, lng: -1.8700, description: "Prise d'eau dans la Loire" },
      { name: 'Usine du Carnet', type: 'traitement', lat: 47.2700, lng: -1.9200, description: 'Station de traitement' },
      { name: 'Réservoir de Méan', type: 'reservoir', lat: 47.2800, lng: -2.1800, description: 'Château d\'eau principal' },
      { name: 'Saint-Nazaire', type: 'commune', lat: 47.2734, lng: -2.2134, description: 'Distribution aux 72 000 habitants' },
    ],
    communes: [
      { name: 'Pornichet', lat: 47.2630, lng: -2.3370, population: 11000 },
      { name: 'Trignac', lat: 47.3100, lng: -2.1950, population: 8500 },
      { name: 'Montoir-de-Bretagne', lat: 47.3300, lng: -2.1500, population: 7500 },
      { name: 'Donges', lat: 47.3180, lng: -2.0800, population: 7500 },
    ],
  },
  {
    id: 'lorient',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Scorff', type: 'captage', lat: 47.8100, lng: -3.3300, description: "Prise d'eau dans le Scorff" },
      { name: 'Usine de Pont-Scorff', type: 'traitement', lat: 47.8300, lng: -3.4000, description: 'Station de potabilisation' },
      { name: 'Réservoir de Keryado', type: 'reservoir', lat: 47.7400, lng: -3.3700, description: 'Réservoir de distribution' },
      { name: 'Lorient', type: 'commune', lat: 47.7484, lng: -3.3660, description: 'Distribution aux 57 000 habitants' },
    ],
    communes: [
      { name: 'Lanester', lat: 47.7620, lng: -3.3400, population: 23000 },
      { name: 'Ploemeur', lat: 47.7350, lng: -3.4270, population: 18000 },
      { name: 'Hennebont', lat: 47.8050, lng: -3.2750, population: 16000 },
      { name: 'Larmor-Plage', lat: 47.7100, lng: -3.3880, population: 8500 },
    ],
  },
  {
    id: 'vannes',
    ...
    sourceType: 'nappe',
    steps: [
      { name: 'Nappe de Noyalo', type: 'captage', lat: 47.6100, lng: -2.7200, description: 'Captage nappe alluviale' },
      { name: 'Usine de Beau Soleil', type: 'traitement', lat: 47.6300, lng: -2.7400, description: 'Station de traitement' },
      { name: 'Réservoir de Kercado', type: 'reservoir', lat: 47.6400, lng: -2.7600, description: 'Château d\'eau' },
      { name: 'Vannes', type: 'commune', lat: 47.6559, lng: -2.7603, description: 'Distribution aux 55 000 habitants' },
    ],
    communes: [
      { name: 'Séné', lat: 47.6270, lng: -2.7340, population: 9500 },
      { name: 'Saint-Avé', lat: 47.6820, lng: -2.7350, population: 11000 },
      { name: 'Arradon', lat: 47.6270, lng: -2.8100, population: 6000 },
      { name: 'Theix-Noyalo', lat: 47.6300, lng: -2.6650, population: 8000 },
    ],
  },
  {
    id: 'quimper',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Odet', type: 'captage', lat: 48.0200, lng: -4.0700, description: "Prise d'eau dans l'Odet" },
      { name: 'Usine de Troheïr', type: 'traitement', lat: 47.9900, lng: -4.1100, description: 'Station de potabilisation' },
      { name: 'Réservoir de Kerfeunteun', type: 'reservoir', lat: 47.9950, lng: -4.1000, description: 'Château d\'eau' },
      { name: 'Quimper', type: 'commune', lat: 47.9960, lng: -4.1024, description: 'Distribution aux 63 000 habitants' },
    ],
    communes: [
      { name: 'Ergué-Gabéric', lat: 47.9920, lng: -4.0250, population: 9000 },
      { name: 'Pluguffan', lat: 47.9700, lng: -4.1760, population: 4500 },
      { name: 'Plomelin', lat: 47.9540, lng: -4.1530, population: 5000 },
      { name: 'Guengat', lat: 47.9800, lng: -4.1900, population: 2000 },
    ],
  },
  {
    id: 'ajaccio',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Gravona', type: 'captage', lat: 42.0050, lng: 8.9500, description: "Prise d'eau dans la Gravona" },
      { name: 'Usine de Campo dell\'Oro', type: 'traitement', lat: 41.9250, lng: 8.8050, description: 'Station de traitement' },
      { name: 'Réservoir des Cannes', type: 'reservoir', lat: 41.9300, lng: 8.7500, description: 'Réservoir de distribution' },
      { name: 'Ajaccio', type: 'commune', lat: 41.9263, lng: 8.7369, description: 'Distribution aux 72 000 habitants' },
    ],
    communes: [
      { name: 'Bastelicaccia', lat: 41.9500, lng: 8.8120, population: 3700 },
      { name: 'Sarrola-Carcopino', lat: 42.0050, lng: 8.8400, population: 4500 },
      { name: 'Afa', lat: 41.9800, lng: 8.7800, population: 3800 },
    ],
  },
  {
    id: 'bastia',
    ...
    sourceType: 'riviere',
    steps: [
      { name: 'Captage Golo', type: 'captage', lat: 42.4800, lng: 9.3500, description: "Prise d'eau dans le Golo" },
      { name: 'Usine d\'Arena', type: 'traitement', lat: 42.5900, lng: 9.4300, description: 'Station de potabilisation' },
      { name: 'Réservoir de Toga', type: 'reservoir', lat: 42.6900, lng: 9.4400, description: 'Réservoir principal' },
      { name: 'Bastia', type: 'commune', lat: 42.6975, lng: 9.4509, description: 'Distribution aux 48 000 habitants' },
    ],
    communes: [
      { name: 'Furiani', lat: 42.6630, lng: 9.4200, population: 6000 },
      { name: 'Biguglia', lat: 42.6250, lng: 9.4280, population: 8000 },
      { name: 'Ville-di-Pietrabugno', lat: 42.7100, lng: 9.4250, population: 4000 },
    ],
  },
];
