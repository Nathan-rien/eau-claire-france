...
export const PROFILES: Record<Profile, ProfileConfig> = {
  purity: {
    ...
    icon: "💎",
    weights: { nitrates:14, residu:14, calcium:4, magnesium:4, sodium:12, pH:6, bicarbonates:4, sulfates:8, fluorure:8, potassium:2, chlorures:4 },
    rules: {
      nitrates:    { type:"low-better", fullAt:1,    zeroAt:15 },
      residu:      { type:"window",     min:0,       optLow:10,  optHigh:150, max:500 },
      calcium:     { type:"window",     min:0,       optLow:5,   optHigh:80,  max:200 },
      magnesium:   { type:"window",     min:0,       optLow:1,   optHigh:25,  max:80 },
      sodium:      { type:"low-better", fullAt:5,    zeroAt:30 },
      pH:          { type:"window",     min:5.5,     optLow:6.5, optHigh:7.5, max:8.5 },
      bicarbonates:{ type:"window",     min:0,       optLow:10,  optHigh:200, max:600 },
