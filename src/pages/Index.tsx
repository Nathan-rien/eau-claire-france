  ...
  return (
    <Layout>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-background to-green-50">
        ...
        <section className="py-6 md:py-10 lg:py-12 px-4 bg-gradient-to-br from-primary/10 via-blue-50 to-primary/5 relative overflow-hidden bg-sky-50" role="region" aria-labelledby="monitor-title">
