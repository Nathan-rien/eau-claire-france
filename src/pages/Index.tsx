        ...
        <section className="py-12 md:py-16 px-4">
          <div className="container mx-auto text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8 md:mb-12 px-4">
                <a href="/carte" className="group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-blue-100 hover:shadow-lg transition-all group-hover:scale-105">
                    <MapPin className="w-6 h-6 md:w-8 md:h-8 text-blue-600 mx-auto mb-2" />
                    <div className="text-sm md:text-lg font-bold text-blue-600">Carte</div>
                    <div className="text-xs md:text-sm text-gray-600">Nationale</div>
                  </div>
                </a>
                <a href="/diagnostic" className="group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-green-100 hover:shadow-lg transition-all group-hover:scale-105">
                    <Search className="w-6 h-6 md:w-8 md:h-8 text-green-600 mx-auto mb-2" />
                    <div className="text-sm md:text-lg font-bold text-green-600">Diagnostic</div>
                    <div className="text-xs md:text-sm text-gray-600">Personnalisé</div>
                  </div>
                </a>
                <a href="/bouteilles" className="group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-orange-100 hover:shadow-lg transition-all group-hover:scale-105">
                    <TrendingUp className="w-6 h-6 md:w-8 md:h-8 text-orange-600 mx-auto mb-2" />
                    <div className="text-sm md:text-lg font-bold text-orange-600">vs Bouteilles</div>
                    <div className="text-xs md:text-sm text-gray-600">Comparaison</div>
                  </div>
                </a>
                <a href="/polluants" className="group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-lg p-4 md:p-6 border border-purple-100 hover:shadow-lg transition-all group-hover:scale-105">
                    <AlertTriangle className="w-6 h-6 md:w-8 md:h-8 text-purple-600 mx-auto mb-2" />
                    <div className="text-sm md:text-lg font-bold text-purple-600">Polluants</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8 md:mb-12 px-4">
                <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 md:p-4 border border-blue-100">
                  <div className="text-xl md:text-2xl font-bold text-blue-600">35,000+</div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 md:p-4 border border-purple-100">
                  <div className="text-xl md:text-2xl font-bold text-purple-600">24h</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 px-4">
              <Card className="border-blue-100 hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg md:text-xl">Score de confiance</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-green-100 hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg md:text-xl">Impact environnemental</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm md:text-base">
              ...
              <Card className="border-orange-100 hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg md:text-xl">Plateforme citoyenne</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 text-sm md:text-base">
