...
export default function GuideNitratesEau() {
  ...
  const links = [
    ...
    { to: "/guide/plomb-eau", title: t(`${PREFIX}.links.plomb`), desc: t(`${PREFIX}.links.plomb.desc`) },
  ...
  return (
    <Layout>
      <SEOHead
        ...
        description={t(`${PREFIX}.seoDesc`)}
        canonical={CANONICAL}
        keywords="nitrates eau du robinet, limite 50 mg/L nitrates, nitrates nourrisson, osmose inverse nitrates, carafe filtrante nitrates"
        schemaData={schemas}
      />
